...
function loadDestinations()
{
    ...
    $rawDestinations = $db->fetchAll("SELECT * FROM destinations ORDER BY created_at DESC");
...
function loadPackages()
{
    ...
    $fetchedPackages = $db->fetchAll("SELECT * FROM packages ORDER BY created_at DESC");
