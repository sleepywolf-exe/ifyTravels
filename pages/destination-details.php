...
<div id="content-area" class="flex-1 bg-white min-h-screen relative overflow-hidden">
    ...
    <div class="absolute top-0 left-1/2 -translate-x-1/2 w-full text-center pointer-events-none select-none z-0">
        <h2
            class="text-[12rem] md:text-[24rem] font-black text-slate-900 opacity-[0.04] leading-none tracking-tighter uppercase font-heading whitespace-nowrap">
            EXPLORE
        </h2>
    </div>
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-24 relative">
            ...
            <h2 class="text-5xl md:text-7xl font-heading font-black mb-10 text-slate-900 leading-tight">
                About
                <span class="block text-primary italic font-serif font-light text-6xl md:text-8xl mt-2 animate-pulse-slow">
                    <?php echo htmlspecialchars($dest['name']); ?>
                </span>
            </h2>
            <div class="flex flex-col md:flex-row gap-12 items-start">
                ...
                <div class="w-full md:w-1/3 flex flex-col gap-4">
                     <div class="p-6 bg-slate-50 border-l-4 border-primary rounded-r-xl">
                        <p class="text-slate-500 italic">"A destination that defines expectations and captures the imagination."</p>
                     </div>
                </div>
            </div>
                        ...
                        <a href="<?php echo package_url($p['slug']); ?>"
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex items-end justify-between border-t border-slate-100 pt-4">
                                    <div>
                                        <span class="text-xs text-slate-400 font-medium block uppercase tracking-wider">Starting
                                            From</span>
                                        <span
