        ...
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            <div id="modalPanel"
                ...
                <div
                    ...
                    <h3 class="text-xl font-bold leading-6 text-white" id="modal-title">Book This Package</h3>
                ...
                <div class="px-4 py-6 sm:p-6">
                    <form id="bookingForm" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="travel_date" id="travel_date" required placeholder="Select Date"
...
<script>
    ...
    function closeBookingModal() {
        ...
        setTimeout(() => {
            ...
            submitBtn.textContent = 'Confirm Inquiry';
        }, 300);
    }
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            submitBtn.disabled = false;
            if (submitBtn.textContent !== 'Confirm Inquiry') { // Only reset text if not success (success closes modal)
                submitBtn.textContent = 'Confirm Inquiry';
            }
        }
    });
