...
<body class="bg-charcoal text-white h-screen flex items-center justify-center p-6 relative overflow-hidden font-body">
    ...
    <div class="max-w-xl w-full text-center relative z-10">
        <div class="w-24 h-24 bg-white/5 rounded-full flex items-center justify-center mx-auto mb-8 border border-white/10 animate-pulse">
        ...
        <h1 class="text-4xl md:text-5xl font-heading font-bold text-white mb-4">Under Maintenance</h1>
