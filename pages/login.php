    ...
    <div class="w-full max-w-md p-6 relative z-10 animate-fade-in-up">
        ...
        <div class="bg-white border border-slate-200 rounded-3xl shadow-2xl relative p-10">
            ...
            <form id="login-form" class="space-y-6">
                ...
                <div id="error-msg"
                    class="hidden bg-red-50 text-red-600 text-sm p-3 rounded-lg border border-red-100 text-center">
                    Invalid credentials.
                </div>
            ...
            <div class="mt-8 text-center">
                <p class="text-slate-500 text-sm">Don't have an account? <a href="<?php echo base_url('register'); ?>"
