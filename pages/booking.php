    ...
    <div class="container mx-auto px-6 relative z-10">
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <!-- Help Box Redesigned -->
                <div
                    class="bg-gradient-to-br from-primary to-emerald-800 rounded-3xl p-8 shadow-2xl shadow-primary/20 relative overflow-hidden group">
                    <!-- Decorative Elements -->
                    <div
                        class="absolute top-0 right-0 w-40 h-40 bg-white/10 rounded-full blur-3xl -mr-16 -mt-16 transition-transform duration-700 group-hover:scale-150">
                    </div>
                    <div class="absolute bottom-0 left-0 w-32 h-32 bg-black/10 rounded-full blur-2xl -ml-16 -mb-16">
                    </div>

                    <h4 class="font-heading font-black text-2xl text-white mb-3 relative z-10 flex items-center gap-2">
                        Need Help?
                    </h4>
                    <p class="text-white/90 text-sm mb-8 leading-relaxed relative z-10 font-medium max-w-[90%]">
                        Our expert travel consultants are available 24/7 to help you plan the perfect trip.
                    </p>

                    <a href="tel:+919999779870"
                        class="flex items-center justify-between bg-white text-primary font-bold rounded-xl px-5 py-4 transition-all duration-300 transform group-hover:-translate-y-1 shadow-xl hover:shadow-2xl relative z-10">
                        <span class="flex items-center gap-3">
                            <span class="bg-primary/10 p-1.5 rounded-full">
                        ...
                        <svg class="w-5 h-5 opacity-50 group-hover:translate-x-1 transition-transform" fill="none"
        ...
        <div class="lg:col-span-2">
            <div class="bg-white border border-slate-100 rounded-[2.5rem] shadow-2xl shadow-slate-200/50 p-8 md:p-12">
